...
def owner_get_all():
    ...
    try:
        ...
        if owners:
            ...
            # Remove prefixos dos campos.
            new_owners = [owner_prefix_remove('owner_', owner) for owner in owners]
...
def owner_get_one(id):
    ...
    try:
        ...
        if owner_row:
            ...
            # Remove prefixos dos campos.
            new_owner = owner_prefix_remove('owner_', owner)
...
def get_items_by_owner(id):
    ...
    try:
        ...
        if items_rows:
            ...
            new_items = [owner_prefix_remove('item_', item) for item in items]
    ...
    try:
        ...
        if item_row:
            ...
            if owner_row:
                ...
                new_item = owner_prefix_remove('item_', item)
                new_owner = owner_prefix_remove('owner_', owner)
